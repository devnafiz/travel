                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Edit place </h1>
                            </div>
                            <form class="user" method="POST"  action="{{route('place.update',$edit_data->id)}}" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group ">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        <input type="text" class="form-control " placeholder="{{ __('Please enter Heading') }}"  id="heading" name="heading" value="{{$edit_data->heading}}">
                                    </div>
                                    
                                </div>
                                <div class="form-group ">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        <input type="text" class="form-control " placeholder="{{ __('Please enter Place name Or hotel name') }}"  id="heading" name="p_name" value="{{$edit_data->p_name}}">
                                    </div>
                                ...
                                <div class="form-group row">
                                     <div class="col-sm-6"> 
                                         <div class="form-group ">
                                          <div class="col-sm-12 mb-3 mb-sm-0">
                                              <input type="text" class="form-control " placeholder="{{ __('Please enter Price ') }}"  id="sale_price" name="sale_price" value="{{$edit_data->sale_price}}">
                                          </div>
                                      ...
                                      <div class="col-sm-6"> 
                                          ...
                                          <div class="form-group ">
                                            <div class="col-sm-12 mb-3 mb-sm-0">
                                                <input type="text" class="form-control " placeholder="{{ __('Please enter Discount Price') }}"  id="discount_price" name="  discount_price" value="{{$edit_data->discount_price}}">
                                            </div>
                                 ...
                                 <div class="form-group row">
                                     <div class="col-sm-6"> 
                                         <div class="form-group ">
                                          <div class="col-sm-12 mb-3 mb-sm-0">
                                              <input type="text" class="form-control " placeholder="{{ __('Please enter Start date ') }}"  id="default-date" name="start_date" value="{{$edit_data->start_date}}" >
                                          </div>
                                      ...
                                      <div class="col-sm-6"> 
                                          ...
                                          <div class="form-group ">
                                            <div class="col-sm-12 mb-3 mb-sm-0">
                                                <input type="text" class="form-control default-date " placeholder="{{ __('Please enter End date') }}"  id="" name="end_date" value="{{$edit_data->end_date}}">
                                            </div>
